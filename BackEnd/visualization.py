...
class VisualForm:
    def __init__(self, scope_data, insight_type, insight_category, insight_score,location):
        ...
        self.vega_json = None
        self.insight_location = location
    ...
    if insight_list['point'] != [] \
        ...
        for category in insight_list:
            ...
            for insight in insights:  
                vis = VisualForm(insight.scope_data, insight.type, insight.category, insight.score, insight.location)
                vis_list.append(vis)
    # sort the vis list
    if len(vis_list) > 1:
